...
import { Search, Plus, Filter, MoreHorizontal, Wallet, CreditCard, PiggyBank, Briefcase, PieChart, Layers, AlertTriangle, Trash2 } from 'lucide-react';
import { TransactionType, AccountType } from './types';

const App: React.FC = () => {
  const { user, onboard, transactions, accounts, deleteTransaction, addTransaction, addAccount, resetStore } = useFinanceStore();
          ...
          <div className="space-y-4">
            ...
            <Button 
              ...
              onClick={() => {
                ...
                // Adiciona uma conta padrão ao iniciar
                addAccount({
      ...
      <main className="px-5">
             ...
             <div className="space-y-4">
               ...
               <Button 
                ...
                onClick={() => {
                  ...
                  if (name) addAccount({ name, balance: 0, currency: 'BRL', type: AccountType.CHECKING, color: '#7F7BD8' });
                }}
               >
        ...
        {activeTab === 'Stats' && (
          <div className="pt-8 space-y-6 pb-24 text-center animate-in zoom-in-95 duration-300">
            <h1 className="text-2xl font-display font-extrabold mb-10">Configurações</h1>
            ...
            <GlassCard className="py-8 border-tanzine-500/20 mb-6">
               ...
               <p className="text-xs text-white/40 mt-2 px-8 leading-relaxed">Adicione mais transações para que a IA possa gerar relatórios detalhados sobre seus hábitos.</p>
            </GlassCard>

            <div className="pt-10 border-t border-white/5">
              <h3 className="text-sm font-black text-red-500 uppercase tracking-[0.2em] mb-4">Zona de Perigo</h3>
              <button 
                onClick={handleReset}
              ...
              <p className="text-[10px] text-white/20 mt-3 px-6 italic">Esta ação é irreversível e apagará todo o histórico de transações e contas.</p>
            </div>
          </div>
        )}
      </main>
